    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', imagekit.models.fields.ProcessedImageField(blank=True, help_text='User profile image (WEBP format)', null=True, upload_to=eleganza.users.validators.secure_avatar_name, validators=[eleganza.users.validators.WebPSecurityValidator()], verbose_name='Avatar')),
